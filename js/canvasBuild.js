 ...
 */
	...
	var canvasBuild = function(backgroundAlpha, canvasID) {
		this.idAnimFrame;
		this.settings = {};
		...
		this.settings.backAlpha = backgroundAlpha === undefined ? 1 : backgroundAlpha;
  ...
  //   	//Loop through all pixels
	...
	canvasBuild.prototype.setAgentFill = function(newFill){
		this.settings.agentFill = newFill;
	};

	canvasBuild.prototype.setAgentFillColor = function(newFillColor){
		this.settings.agentFillColor = newFillColor;
	};
